...
/**
 * Servlet implementation class GetWorkerWorkByUserId
 */
@WebServlet("/GetWorkerWorkByUserId")
public class GetWorkerWorkByUserId extends HttpServlet {
	private static final long serialVersionUID = 1L;
    
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetWorkerWorkByUserId() {
        super();
